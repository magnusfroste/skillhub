...
FILES="skill_library.sql conventions.sql platform.sql platform_lifecycle.sql platform_loading.sql platform_entry.sql platform_vector.sql platform_embed.sql platform_ops.sql platform_asks.sql platform_tools.sql platform_lock.sql"
